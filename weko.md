...
ᴡᴇᴋᴏ uses a comma after **la** where ꜱᴏɴᴊᴀ uses it before **la**. ᴡᴇᴋᴏ sometimes omits the comma to clarify nesting, or if the head phrase is short (more like if there's an adverb for it in English haha gottem).
